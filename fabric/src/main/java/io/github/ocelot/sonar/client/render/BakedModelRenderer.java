...
public class BakedModelRenderer
{
     ...
     */
    public static void renderModel(BakedModel model, VertexConsumer builder, PoseStack matrixStack, float red, float green, float blue, int packedLight, int packedOverlay)
    {
        RANDOM.setSeed(42L);
